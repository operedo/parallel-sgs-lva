...
! 2020-08-09:
!
! This version of the program uses acceleration techniques and parallelization to speedup different parts of the code.
!
! Title of Paper Submitted: Acceleration Strategies for Large-Scale Sequential Gaussian Simulations using Locally Varying Anisotropy
! 
! Authors of paper:
! O. F. PEREDO
! J. R. HERRERO
...
!-----------------------------------------------------------------------
!
!                     SGS WITH LOCALLY VARYING ANISOTROPY
!                     *****************************************
...
!!!!!!! this part is not necessary for large-scale scenarios !!!!!!!              
!          n_searched=0
